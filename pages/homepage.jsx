...
export default function HomePage() {
	...
	return (
		<SectionHomePage id="section-home">
			...
			<Head title="Portfolio" metaDescription="Portfolio of Chinmay Lohani." keywords="Chinmay Lohani, Chinmay, Lohani, Security Engineer, Security, Software, Portifolio, Cybersecurity, Websecurity, Software Security" />
